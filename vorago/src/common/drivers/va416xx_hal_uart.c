...
static eventHandlerIdx_t aRxCallbackIdx[NUM_UARTS] = {eventHandlerIdx_null, eventHandlerIdx_null, eventHandlerIdx_null};
static eventHandlerIdx_t aTxCallbackIdx[NUM_UARTS] = {eventHandlerIdx_null, eventHandlerIdx_null, eventHandlerIdx_null};
